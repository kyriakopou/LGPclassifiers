...
This is a basic example which shows you how generate Reddy COO classifications for a matrix of samples by first normalizing sample tpm counts, then calculating sample COO classifications by comparing to a normalized reference  
...
# Ensure that all columns sum to 10^6 reads
